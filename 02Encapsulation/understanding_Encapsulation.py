...
# You walk up, insert your card, type your PIN and hit "Withdraw $500".
# Money comes out. Done.
# But here is the thing ---
# You did not have to worry about how the ATM verified your PIN internally.
# You did not have to manually check the bank's database yourself.
# You did not have to calculate whether your balance was sufficient.
